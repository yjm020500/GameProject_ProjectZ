...
void Lcd_Write_RAM_Prepare(void) //ram에 그래픽 데이터 쓸 준비
{
	Lcd_WR_REG(lcddev.wramcmd);
}

void Lcd_Set_Windows(unsigned short x1, unsigned short y1, unsigned short x2, unsigned short y2) //cursor 범위지정
{
...
void Lcd_Set_Cursor(unsigned short x, unsigned short y) //cursor 이동
{
